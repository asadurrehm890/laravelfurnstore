...
<main>
  <section class="banner-section ptop100 pbot100">
     <div class="overlay"></div>
        <div class="ptop100 pbot100 position-relative z99">
          <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-12">
                  <div class="position-relative">
                    <img class="img-fluid w-100 mw300 h300 rounded-circle" src="./assets/img/products/p8.jpg" alt="">
                    <div class="w-100 position-absolute top-50 start-50 translate-middle z-9">
                        <div class="bgr ptop100 pbot100 rounded-pill"></div>
                    </div>
  ...
  <section class="latest-section ptop100 pbot100 bbl-005">
    <div class="container">
     ...
     <div class="d-flex justify-content-center flex-wrap">
       ...
       <div class="card border-0 positon-relative p-2 m-3">
          <a href="#"><img src="./assets/img/products/{{ $blog->img }}" alt=""></a>
...
<a href="#" class="btn2">Shop Now <i class="ms-2 fa-solid fa-arrow-right"></i> </a>
     </div>

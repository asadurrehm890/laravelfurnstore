       ...
       <div class="container">
          <div class="row">
             <div class="col-lg-4 col-md-6 col-sm-12">
                  <img class="mx75" src="./assets/img/logo-w.png" alt="">
                  <p class="wh mt-3 mb-3">We Design Our Furnitures following minimalistic philosophies</p>
             ...
             <div class="col-lg-2 col-md-6 col-sm-12">
                    <h5 class="wh fs-5">About</h5>
                    <ul class="list-unstyled">
                      <li class="mt-4"> <a href="#" class="wh">Shop</a> </li>
                      <li class="mt-4"> <a href="#" class="wh">Delivery</a> </li>
                      <li class="mt-4"> <a href="#" class="wh">Returns</a> </li>
                    </ul>
             </div>
             <div class="col-lg-2 col-md-6 col-sm-12">
                    <h5 class="wh fs-5">Help</h5>
                    <ul class="list-unstyled">
                      <li class="mt-4"> <a href="#" class="wh">Order Tracking</a> </li>
                      <li class="mt-4"> <a href="#" class="wh">Faqs</a> </li>
                      <li class="mt-4"> <a href="#" class="wh">Contact Us</a> </li>
                    </ul>
             </div>
             <div class="col-lg-4 col-md-6 col-sm-12">
